# Contributing to gulp-liquid-to-handlebars

First and foremost, thank you! We appreciate that you want to contribute to gulp-liquid-to-handlebars, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for gulp-liquid-to-handlebars**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for gulp-liquid-to-handlebars:

- star the [project](https://github.com/jonschlinkert/gulp-liquid-to-handlebars)
- tweet your support for gulp-liquid-to-handlebars
...
- **version**: please note the version of gulp-liquid-to-handlebars are you using
...
[so]: http://stackoverflow.com/questions/tagged/gulp-liquid-to-handlebars